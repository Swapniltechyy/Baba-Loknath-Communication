        ...
        <div className="relative w-full lg:w-auto lg:p-0">
          ...
          >
            ...
            >
              <a
                href={site.phoneHref}
                className="btn-cta inline-flex items-center gap-2 rounded-lg bg-brand-orange px-5 py-3 text-[15px] font-semibold text-white shadow-lg shadow-brand-orange/25"
              >
              ...
              <a
                ...
                className="btn-cta inline-flex items-center gap-2 rounded-lg bg-brand-green px-5 py-3 text-[15px] font-semibold text-white shadow-lg shadow-brand-green/25"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
          ...
          <div className="relative z-10 shrink-0 lg:hidden">
            <div className="relative flex flex-col px-5 pt-4.5" style={{ minHeight: "calc(100svh - 72px)" }}>
              ...
              <div className="relative z-10 flex gap-3.5">
                ...
                <a
                  href={site.whatsappHref}
                  className="bg-brand-green shadow-brand-green/30 inline-flex flex-1 items-center justify-center gap-2.5 rounded-xl px-3.5 py-3.5 text-[17px] font-bold text-white shadow-lg transition-all duration-200 ease-in-out hover:-translate-y-1 hover:scale-105 hover:bg-[#2bc45a] hover:shadow-xl active:scale-95"
                >
